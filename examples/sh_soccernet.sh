...
#SBATCH --output=colmap_rendering_%j.out
#SBATCH --account=gs_hyperspectral
#SBATCH --error=error_rendering_%j.log 
...
# Training
# -------------------------
srun python /home/hensemberk/dev/Soccernet/gsplat/examples/simple_trainer.py default \
    --max_steps $MAX_STEPS \
    --data_dir $DATA_DIR \
